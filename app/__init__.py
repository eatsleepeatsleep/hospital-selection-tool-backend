...
def plot_truncated_normal(hospital_name, prehospital_time, lower_bound, mean, variance, threshold):
    ...
    plt.axvline(lower_bound_minutes - prehospital_time_minutes, color='#00008B', linestyle='--', label=f'PrehospitalTime + Lower Bound: {round(lower_bound_minutes, 3):.3f} minutes')  
    plt.axvline(mean_minutes, color='#007bff', linestyle='--', label=f'PrehospitalTime + Mean Time: {round(mean_minutes, 3):.3f} minutes')  
    # plt.axvline(mean_minutes - prehospital_time_minutes, color='#007bff', linestyle='--', label=f'PrehospitalTime + Mean Time: {round(mean_minutes, 3):.3f} minutes')  
